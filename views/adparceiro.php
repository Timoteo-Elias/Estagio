...
<?php 
    ...
    if(isset($_POST) && !empty($_POST))
    {
        ...
        $query = mysqli_query($con, "SELECT * FROM parceiro WHERE nome='$nome' OR nif='$nif'");
        ...
        if ($query) {
            ...
            if ($result > 0) {
                ?>
                <script>
                    alert("As Credenciais inseridas já existem. Verifique a lista de parceiros por favor!!");
                </script>
                <?php
            }else{
                $sql = mysqli_query($con, "INSERT INTO parceiro(nome,nif,area,telefone,email,cidade,
            municipio,bairro,foto) 
            VALUES('$nome', '$nif', '$area','$telefone', '$email','$cidade', '$municipio', '$local','$imagem')");
...
<div class="w-100 d-flex justify-content-between">
    ...
    <div class="container w-75 px-4 py-5" id="featured-3">       
        ...
        <div class="w-100 row g-2 py-3">                
            <form class="row w-100 bg-light" action="adparceiro.php" method="post"  enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="area" class="form-select" required>
                            <option>selecionar area de  ensino</option>
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input name="municipio" type="text" class="form-control" required>
                    </div>
