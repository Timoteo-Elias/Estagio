...
<div class="container w-75 d-flex justify-content-between mt-5 rounded-3" style="background-color:#ffffff">
    <div class=" px-4 py-3" id="featured-3">       
        <div class="w-100 row g-2 py-3">                
            <form action="edituser.php" class="row w-100" method="post"  enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-6">
                        <label for="firstName" class="form-label">Nome de usuario</label>
                        <input value="<?php echo $linha['nome'] ?>" name="nome" type="text" class="form-control" placeholder="Nome completo" value="" required>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <label for="perfil" class="form-label">Perfil</label>
                         <select value="" name="perfil" class="form-select"  required>
                            <option value="<?php echo $linha['perfil'] ?>"><?php echo $linha['perfil'] ?></option>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input value="<?php echo $linha['senha'] ?>" name="senha" type="password" class="form-control"  placeholder="Senha">
                    </div>
                    <div class="mt-2 col-sm-12">
                        ...
                        <div class="container w-50 mt-2">
                            <img class="w-20" width="150" id="preview" src="<?php echo $linha['foto'] ?>">
                        </div>
