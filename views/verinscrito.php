...
<div class="container w-75 d-flex justify-content-between mt-2 rounded-3" style="background-color:#ffffff">
    ...
    <div class="container px-4 py-5" id="featured-3">
        ...
        <div class="row">
            <div class="col-sm-4">
                <label for="bairro" class="form-label">Instituição que frequenta</label>
                <input value="<?php echo $linha['instituto'] ?>" type="text" class="form-control"disabled>
            </div> 
            <div class="col-sm-3">
                <label for="bairro" class="form-label">Ensino</label>
                <input value="<?php echo $linha['ensino'] ?>" type="text" class="form-control"disabled>
            </div> 
            <div class="col-sm-3">
        ...
        <div class="text-center">
            <label for="bairro" class="form-label">Certificado ou declaração com notas</label>
        </div>
        <div  class="d-flex justify-content-center align-items-center">
            <img src="../<?php echo $linha['foto'] ?>" width="550">
        </div>
        <hr>
        <div class="col-sm-3">
            <label for="bairro" class="form-label">Data de inscrição</label>
            <input value="<?php echo $linha['datainscricao'] ?>" type="text" class="form-control"disabled>
        </div> 
        <hr>
        <div>
            <a class="btn btn-outline-primary" href="inscrito.php"><i class="bi bi-backspace-fill mt-2"> Voltar</i></a>
        </div>
