...
$sql = "SELECT a.comportamento, a.participacao, a.desempenho, e.nome
FROM avaliar a INNER JOIN estagiarios e ON a.idestagiario=e.id";
...
$dompdf->stream("Avaliação.pdf", ["Attachment" => false]);
?>