...
<?php 
    ...
    $sql = "SELECT e.idequipa, es.nome as estagiario,es.bi, es.curso, g.nome as grupo, g.categoria 
    FROM equipa e inner join estagiarios es on e.idestagiario=es.id 
    inner join grupo g on e.idgrupo=g.idgrupo WHERE g.nome LIKE '%$pesquisar%'
    ORDER BY es.nome";
...
<div class="container w-75 d-flex justify-content-between mt-5 rounded-3" style="background-color:#ffffff">
    ...
    <div class="container px-4 py-3" id="featured-3">
        ...
        <div class="d-flex justify-content-between mt-5">
            <form action="equipa.php" method="post" class=" d-flex" role="search">
                <input name="pesquisa" class="form-control me-2" type="search" placeholder="Buscar grupo" aria-label="Search">
                <button class="btn btn-outline-success" type="submit"><i class="bi bi-search"></i></button>
            </form>
            <div>
                <a class="btn btn-outline-danger"  target="_blank" href="equipapdf.php"><i class="bi bi-file-pdf-fill"></i></i></a>
                <a class="btn btn-outline-success" href="estagiarios.php"><i class="bi bi-backspace-fill mt-2"></i></a>
                <a class="btn btn-outline-primary" href="adequipa.php" ><i class="bi bi-plus-lg"></i></a>
            </div>            
        </div>
