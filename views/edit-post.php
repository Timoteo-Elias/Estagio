...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    ...
    if(isset($_POST) && !empty($_POST))
    {
        ...
        $sql = mysqli_query($con, "UPDATE vagas SET area='$area', descricao='$descricao', totalvagas='$total'
        WHERE id={$id}");
...
<div class="container w-75 d-flex justify-content-between mt-5 rounded-3" style="background-color:#ffffff">
    ...
    <div class="container px-4 py-3" id="featured-3">
        <form action="edit-post.php" class="row w-100" method="post"  enctype="multipart/form-data">
            <div class="row ">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input value=" <?php echo $linha['descricao'] ?>" name="descricao" type="text" class="form-control" required>
                </div>
                <div class="col-sm-6">
                    <label for="lastName" class="form-label">Nº de vagas</label>
                    <input value=" <?php echo $linha['totalvagas'] ?>" name="total" type="text" class="form-control" required>
                </div>
            </div>     
            <div>
